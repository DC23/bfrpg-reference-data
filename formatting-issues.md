...
- **Typographic quotes throughout**: The source uses Unicode curly apostrophes (U+2019 ') and quote marks rather than ASCII equivalents. Ensure fixture strings are pasted without alteration from the source. If an editor swaps those characters out for ASCII equivalents, the tests will fail.
